...
if (isset($_POST['addnews'])) {
    ...
    if(!empty($_FILES["image"]["name"])) { 
        ...
        $sql = "INSERT INTO news (`title`, `description`, `video` ,`image`, `image2`, `image3`) VALUES ('$title', '$desc', '$vidContent','$imgContent', '$img2Content', '$img3Content')";
    ...
    if ($vidbadres != '1') {
        header("Location: ../politicalwp.themeslr.com/news-form/index.php?res=newsadded");
ob_end_flush();
    } else {
        header("Location: ../politicalwp.themeslr.com/news-form/index.php?res=newsadded&vb=1");
ob_end_flush();
    }
