					...
					<div class="row">
						...
						<div class="navbar-header col-md-3"> <button type="button" class="navbar-toggle collapsed"
							...
							<h1 class="logo"> <a href="index.php"> <img
										...
										alt="PoliticalWP" /> </a></h1>
						</div><!-- NAV MENU -->
						<div id="navbar" class="navbar-collapse collapse col-md-9">
							<ul class="menu nav navbar-nav nav-effect nav-menu pull-right">
								<li id="menu-item-6286"
									class="menu-item menu-item-type-post_type menu-item-object-page menu-item-home current-menu-ancestor current-menu-parent current_page_parent current_page_ancestor menu-item-6286">
									<a href="#">Home</a>
								</li>
								<li id="menu-item-6286"
											...
											<div class="wpb_column vc_column_container vc_col-sm-12">
												<div class="vc_column-inner">
													<div class="wpb_wrapper">
														...
														<div class="mt-icon-list-item"><a href="goals-set/index.php">
																<p class="mt-icon-list-text"
							...
							if (isset($_SESSION['isLoggedIn']) == true && isset($_SESSION['userDegree']) == true) {
														...
														<div class="mt-icon-list-item"><a
															...
															?>
														<div class="mt-icon-list-item"><a href="clc-body/index.php">
																<p class="mt-icon-list-text"
											...
											<div class="wpb_column vc_column_container vc_col-sm-12">
												<div class="vc_column-inner">
													<div class="wpb_wrapper">
														<div class="vc_empty_space" style="height: 20px"><span
																class="vc_empty_space_inner"></span></div>
														<div class="mt-icon-list-item"><a href="youth-wing/index.php">
																<p class="mt-icon-list-text"
								...
								<li id="menu-item-6286"
									class="menu-item menu-item-type-post_type menu-item-object-page menu-item-6286"><a
										href="constituencies/index.php">Constituencies</a></li>
								<li id="menu-item-6286"
									class="menu-item menu-item-type-post_type menu-item-object-page menu-item-6286"><a
...
<div class="mt-icon-list-item"><a href="<?php echo ($_SESSION['userDegree'] == 0 || $_SESSION['userDegree'] == 2)? "voter-registeration/index.php": ""; ?>">
																<p class="mt-icon-list-text"
