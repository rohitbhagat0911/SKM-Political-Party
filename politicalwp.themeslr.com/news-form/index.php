...
<body data-rsssl=1
    ...
    <div id="page" class="hfeed site">
        ...
        <div style="text-align: center; font-size: 0.1em;"><h1>Add News</h1></div>
...
<form accept-charset="UTF-8" action="../../server/newsadd.php" method="POST"
...
<form accept-charset="UTF-8" action="../../server/newsedit.php" method="POST"
                enctype="multipart/form-data">
                <div class="form-group"> 
                    <label for="title">Title</label>
                    <input type="text" name="title" class="form-control" id="title" placeholder="Enter the title"
                      value="<?php echo $news['title']; ?>" required="required">
                </div>
                <div class="form-group">
                    <label for="description">Enter Description:</label>
                    <textarea id="description" name="description" class="form-control" rows="4" cols="50" maxlength="1000" required="required" placeholder="Enter Description"><?php echo $news['description']; ?></textarea>
                </div>
                <div class="form-group mt-3">
