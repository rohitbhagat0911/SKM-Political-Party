...
<head>
    ...
    <link rel="stylesheet" href="../constituency/index.css">
    <title>Constituencies - SKM</title>
    ...
    <script defer type='text/javascript'
        ...
        id='fvm-header-1-js'></script><noscript>
        <style>
        ...
        <div id="tribe-events-pg-template" class="high-padding container">
            <div id="tribe-events" class="tribe-no-js" data-live_ajax="1" data-datepicker_format="1" data-category=""
                ...
                ?>
                    ...
                    <?php
					if (isset($_SESSION['isLoggedIn']) == true && ($_SESSION['userDegree'] == 0|| $_SESSION['userDegree'] == 2  || $_SESSION['userDegree'] == 1 )) {

                    ?>
                    <form action=""  method="post">
                <div class="searchbar">
                <input type="text" name="searchData" class="searchTerm" placeholder="Search with voter id or name" required>
                    <button type="submit" name="searchTap" class="searchButton">
                                                ...
                                                <tr>
                                                        ...
                                                        <div style="display: flex; flex-direction: row;">
                                                            ...
                                                            <div
                                                                ...
                                                                <a href="../application-view/index.php?id=<?php echo $scs['id']; ?>"
                ...
                ?>
                 ...
                 <div id="tribe-events-content-wrapper" class="tribe-clearfix"><input type="hidden"
                    ...
                    <div id="tribe-events-content" class="tribe-events-list">
                        <h2 class="tribe-events-page-title">Constituencies</h2> 
                        <div class="tribe-events-loop">
                            ...
                            ?>
                                ...
                                <h2 class="tribe-events-list-event-title"><?php echo $cons['name']; ?></h2>
                                <a href="../event-form/index.php" class="add-button">Add News/Events</a>

                                <p class="about-constituency"><?php 
                                $pieces = explode(" ", $cons['description']);
                                $first_part = implode(" ", array_splice($pieces, 0, 32));
                                echo  $first_part. ' ....'; 
                                ?></p>
                                <h6 class="check-events"><a href="../constituency?con=<?php echo $cons['id']; ?>">See more</a>
