	...
	require_once "navbar.php";
		...
		<div class="theme_header_slider">
			...
			<rs-module-wrap id="rev_slider_1_1_wrapper" data-source="gallery"
				...
				<rs-module id="rev_slider_1_1" style="" data-version="6.2.23">
					<rs-slides>
						<rs-slide data-key="rs-1" data-title="Slide" data-anim="ei:d;eo:d;s:600;r:0;t:fade;sl:d;">
						 <img
								 title="Home Main"
								data-bg="p:center right;" data-panzoom="d:10000;e:power1.in;ss:100;se:120;"
								class="rev-slidebg" data-no-retina>
							<rs-layer id="slider-1-slide-1-layer-2" data-type="text" data-color="rgba(255, 255, 255, 1)"
								data-rsp_ch="on" data-xy="x:r;xo:19px;y:179px;" data-text="s:70;l:75;fw:700;a:inherit;"
								data-frame_0="y:-50px;tp:600;" data-frame_1="tp:600;sp:1500;"
								data-frame_999="o:0;tp:600;st:w;sR:7500;" style="z-index:5;font-family:Arvo;">THE
								PROSPERITY <BR /> BEGINS TODAY </rs-layer>
							
							<rs-layer id="slider-1-slide-1-layer-3" data-type="text" data-color="rgba(255, 255, 255, 1)"
								data-rsp_ch="on" data-xy="x:573px;y:332px;" data-text="s:20;l:28;a:inherit;"
								data-frame_0="tp:600;" data-frame_1="tp:600;" data-frame_999="o:0;tp:600;st:w;sR:8700;"
								style="z-index:6;font-family:Open Sans;">Political authentic senate voting chambray
								quinoa.<BR /> sriracha, tacos skateboard migas farm-to-table. </rs-layer>
							<rs-layer id="slider-1-slide-1-layer-5" data-type="image" data-rsp_ch="on"
								data-xy="x:51px;y:50px;" data-text="l:22;a:inherit;" data-dim="w:466px;h:553px;"
								data-frame_0="tp:600;" data-frame_1="tp:600;" data-frame_999="o:0;tp:600;st:w;sR:8700;"
								style="z-index:8;"><img
									src="wp-content/uploads/2017/04/political_business_president_man.png" 
									width="1094"
									height="1296" data-no-retina> </rs-layer>

						</rs-slide>
						<rs-slide data-key="rs-2" data-title="Slide"
							data-thumb="//politicalwp.themeslr.com/wp-content/uploads/2017/05/politicalwp_crowd_black-100x50.jpg"
							data-anim="ei:d;eo:d;s:600;r:0;t:fade;sl:d;"> <img
								 title="Home Main"
								data-panzoom="d:10000;ss:100;se:120;" class="rev-slidebg" data-no-retina>

							<rs-layer id="slider-1-slide-2-layer-2" data-type="text" data-color="rgba(255, 255, 255, 1)"
								data-rsp_ch="on" data-xy="x:c;xo:-2px;y:c;yo:-46px;"
								data-text="s:70;l:75;fw:700;a:center;" data-frame_0="tp:600;"
								data-frame_1="tp:600;sR:10;" data-frame_999="o:0;tp:600;st:w;sR:8690;"
								style="z-index:5;font-family:Arvo;">NOW, TODAY <BR /> EVERYTHING CHANGES </rs-layer>
							<!---->
							<rs-layer id="slider-1-slide-2-layer-3" data-type="text" data-color="rgba(255, 255, 255, 1)"
								data-rsp_ch="on" data-xy="x:c;y:350px;" data-text="s:20;l:28;a:center;"
								data-frame_0="tp:600;" data-frame_1="tp:600;sR:10;"
								data-frame_999="o:0;tp:600;st:w;sR:8690;" style="z-index:6;font-family:Open Sans;">
								Post-ironic authentic drinking vinegar chambray quinoa. VHS letterpress<BR /> sriracha,
								tacos skateboard migas farm-to-table artisan kombucha. </rs-layer>
							<rs-layer id="slider-1-slide-2-layer-5" class="rev-btn" data-type="button"
								data-color="rgba(255, 255, 255, 1)" data-xy="x:c;y:c;yo:153px;"
								data-text="s:17;l:17;fw:600;a:inherit;" data-vbility="t,t,t,f" data-rsp_bd="off"
								data-padding="t:15;r:25;b:15;l:25;" data-frame_0="tp:600;" data-frame_1="tp:600;sR:10;"
								data-frame_999="o:0;tp:600;st:w;sR:8690;"
								data-frame_hover="bgc:rgba(227,17,26,1);boc:#000;bor:0px,0px,0px,0px;bos:solid;oX:50;oY:50;sp:0;"
								style="z-index:8;background-color:rgba(227,17,26,1);font-family:Open Sans;cursor:pointer;outline:none;box-shadow:none;box-sizing:border-box;-moz-box-sizing:border-box;-webkit-box-sizing:border-box;">EVENTS/NEWS</rs-layer>
						</rs-slide>
					</rs-slides>
				</rs-module>
				<script
					type="text/javascript">setREVStartSize({ c: 'rev_slider_1_1', rl: [1240, 1024, 768, 480], el: [600], gw: [1240], gh: [600], type: 'standard', justify: '', layout: 'fullwidth', mh: "0" });
						var revapi1,
							tpj;
						...
						if (document.readyState === "loading") { document.addEventListener('readystatechange', function () { if ((document.readyState === "interactive" || document.readyState === "complete") && !once_revslider11) { once_revslider11 = true; revinit_revslider11(); } }); } else { once_revslider11 = true; revinit_revslider11(); }</script>
				...
				<script>var htmlDivCss = unescape("%0A%0A%0A%0A%0A%0A");
					var htmlDiv = document.getElementById('rs-plugin-settings-inline-css');
					if (htmlDiv) {
						htmlDiv.innerHTML = htmlDiv.innerHTML + htmlDivCss;
					} else {
			...
			<div class="container">
										...
										<div class="vc_column-inner">
											<div class="wpb_wrapper">
												<div class="title-subtile-holder">
													<h1 class="section-title dark_title">Goals &amp; Achievements</h1>
													<div class="section-subtitle dark_subtitle">Achievements are now
														made easy using Political WordPress Theme! Share the news and
														press releases to your focus group and complete causes using
														donations.</div>
													<br>
													<div class="see-more-section"><a href="goals-achieved/index.php"
															class="see-more-button">See Achieved Goals</a></div>
												</div>
											</div>
										</div>
									</div>
								...
								<div data-vc-full-width="true" data-vc-full-width-init="false"
									...
									<div class="wpb_column vc_column_container vc_col-sm-12">
										<div class="vc_column-inner vc_custom_1450339501388">
											<div class="wpb_wrapper">
												<div class="title-subtile-holder">
													<h1 class="section-title dark_title">Latest News</h1>
												</div>
				...
				if($newsDetails != FALSE && $newsDetails->num_rows > 0) {
														...
														<article class="single-post list-view">
															<div class="blog_custom">
																...
																<div class="post-details col-md-12">
																	<h3 class="text-center post-name row"> <?php echo $news['title']; ?> </h3>
					...
					$th++;
												...
												<div class="see-more-section"><a href="news/"
														class="see-more-button">See More</a></div>
									...
									<div class="wpb_column vc_column_container vc_col-sm-12">
										<div class="vc_column-inner">
											<div class="wpb_wrapper">
												...
												<div class="see-more-section"><a href="cabinet-members/index.php"
														class="see-more-button">See More</a></div>
