<?php
session_start();
require_once '../../server/visiondata.php';
...
<head>
	...
	<title>What We Fight For &#8211; SKM</title>
...
/*  */</script>
	...
	<link rel="alternate" type="application/json" href="../wp-json/wp/v2/pages/6021.json" />
	<link rel="canonical" href="index.html" />
	<link rel="alternate" type="application/json+oembed"
		href="../wp-json/oembed/1.0/embedfe86.json?url=https%3A%2F%2Fpoliticalwp.themeslr.com%2Fwhat-we-fight-for%2F" />
	<link rel="alternate" type="text/xml+oembed"
		href="../wp-json/oembed/1.0/embed1829?url=https%3A%2F%2Fpoliticalwp.themeslr.com%2Fwhat-we-fight-for%2F&amp;format=xml" />
	...
	<style type="text/css" data-type="vc_shortcodes-custom-css">
		...
		.vc_custom_1493851884649 {
			padding-top: 70px !important;
			padding-bottom: 90px !important;
			background-image: url(../wp-content/uploads/2017/05/politicalwp_crowd_black17e8.jpg?id=6388) !important;
			background-position: center !important;
			background-repeat: no-repeat !important;
			background-size: cover !important;
		}

		.vc_custom_1493852155456 {
...
<body data-rsssl=1
	class="page-template-default page page-id-6021 theme-politicalwp woocommerce-no-js tribe-no-js       header1   wpb-js-composer js-comp-ver-6.4.0 vc_responsive">
	<!-- PAGE #page -->
		...
		<div id="primary" class=" content-area no-sidebar">
			<div class="container">
						...
						<article id="post-6021" class="post-6021 page type-page status-publish hentry">
							<div class="entry-content">
								<div data-vc-full-width="true" data-vc-full-width-init="false"
									class="vc_row wpb_row vc_row-fluid vc_custom_1493851574796 vc_row-has-fill">
									...
									if (isset($_SESSION['isLoggedIn']) == true && ($_SESSION['userDegree'] == 0 || $_SESSION['userDegree'] == 1 )) {
											?>
				<a href="./?add=vision">Add Vision</a> </br>
											<?php
																		if (isset($_GET['eid'])) {
																			if($visionDetail != FALSE && $visionDetail->num_rows > 0) {
																				while ($vision = $visionDetail->fetch_assoc()) {
																					if ($_GET['eid'] == $vision['id']) {
																						
																			?>
																				<form accept-charset="UTF-8" action="../../server/editvision.php" method="POST">
											
											<div class="form-group">
												<label for="description">Edit Vision:</label>
												<textarea id="description" name="desc" class="form-control" rows="4" cols="50" maxlength="1000" required="required" placeholder="Edit vision"><?php echo $vision['goals']; ?> </textarea>
											</div>
											<input type="hidden" name="id" value="<?php echo $vision['id']; ?>">
											<hr>
											<button type="submit" class="btn btn-primary" name="editvision">Submit</button>
										</form>	
																			<?php
																					}
											...
											if (isset($_GET['res']) && $_GET['res'] == 1) {
												?>
														...
														<?php
											} elseif ((isset($_GET['res']) && $_GET['res'] == 0) || (isset($_GET['delete']) && $_GET['delete'] == 0) || (isset($_GET['e']) && $_GET['e'] == 0)) {
												?>
												<script>
											...
											if ((isset($_GET['add']) && $_GET['add'] == 'vision')) {
												?>
												<form accept-charset="UTF-8" action="../../server/addvision.php" method="POST">
                
                <div class="form-group">
                    <label for="description">Enter new Vision:</label>
                    <textarea id="description" name="desc" class="form-control" rows="4" cols="50" maxlength="1000" required="required" placeholder="Enter vision"></textarea>
                </div>
                
                <hr>
                <button type="submit" class="btn btn-primary" name="addvision">Submit</button>
            </form>
											...
											?>
												<div class="title-subtile-holder">
													<h1 class="section-title dark_title">Our Vision
													</h1>
													</br>
													<p class="section-title"><i>The following shall be the Aims and
															Objectives, or the “Dozen Doctrine”, of the Party: </i></p>
													</br>
													<ul>
													<?php

												if($visionDetails != FALSE && $visionDetails->num_rows > 0) {
													while ($visions = $visionDetails->fetch_assoc()) {
									if (isset($_SESSION['isLoggedIn']) == true && ($_SESSION['userDegree'] == 0 || $_SESSION['userDegree'] == 1 )) {

													?>
				<a href="./?eid=<?php echo $visions['id']; ?>">Edit Vision</a> </br>
				<a href="../../server/deletevision.php?id=<?php echo $visions['id']; ?>">Delete Vision</a> </br>
				...
				?>
													...
													<li class="section-subtitle dark_subtitle">
													<?php echo $visions['goals']; ?>
													</li>
														<br>
