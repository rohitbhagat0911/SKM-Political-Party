<?php
session_start();
require_once '../../server/goalsset.php';
        ...
        <div id="primary" class=" content-area no-sidebar">
            <div class="container">
				...
				<a href="./?add=vision">Add Goals achieved</a> </br>
											<?php
																		if (isset($_GET['eid'])) {
																			if($gsDetail != FALSE && $gsDetail->num_rows > 0) {
																				while ($gs = $gsDetail->fetch_assoc()) {
																					if ($_GET['eid'] == $gs['id']) {
																						
																			?>
																				<form accept-charset="UTF-8" action="../../server/editgoalset.php" method="POST">
											
											<div class="form-group">
												<label for="description">Edit Goal:</label>
												<textarea id="description" name="desc" class="form-control" rows="4" cols="50" maxlength="1000" required="required" placeholder="Edit Goal"><?php echo $gs['goals']; ?> </textarea>
											</div>
											<input type="hidden" name="id" value="<?php echo $gs['id']; ?>">
											<hr>
											<button type="submit" class="btn btn-primary" name="editgs">Submit</button>
										</form>	
																			<?php
																					}
											...
											if ((isset($_GET['add']) && $_GET['add'] == 'vision')) {
												?>
												<form accept-charset="UTF-8" action="../../server/addgoalset.php" method="POST">
                
                <div class="form-group">
                    <label for="description">Enter goal:</label>
                ...
                <hr>
                <button type="submit" class="btn btn-primary" name="addglset">Submit</button>
            </form>
											...
											?>
                                                <div class="title-subtile-holder">
                                                    <h1 class="section-title dark_title">Goals Set
                                                    </h1>
                                                    </br>
                                                    ...
                                                    <?php
                                                        ...
                                                        if($gsDetails != FALSE && $gsDetails->num_rows > 0) {
                                                            while ($gss = $gsDetails->fetch_assoc()) {
									if (isset($_SESSION['isLoggedIn']) == true && ($_SESSION['userDegree'] == 0 || $_SESSION['userDegree'] == 1 )) {

                                                            ?>
                                                        <a href="./?eid=<?php echo $gss['id']; ?>">Edit Goals achieved</a> </br>
                                                        <a href="../../server/deletegoalset.php?did=<?php echo $gss['id']; ?>">Delete Goals achieved</a> </br>
                                                        <?php
                                    }
                                                        ?>
