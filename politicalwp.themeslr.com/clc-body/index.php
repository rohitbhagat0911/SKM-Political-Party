                                                ...
                                                <div class="vc_column-inner">
                                                    <div class="wpb_wrapper">
                                                        ...
                                                        <div class="mt-icon-list-item"><a
                                                                href="../what-we-fight-for/index.php">
                                            ...
                                            <div class="wpb_column vc_column_container vc_col-sm-12">
                                                <div class="vc_column-inner">
                                                    <div class="wpb_wrapper">
                                                        ...
                                                        <div class="mt-icon-list-item"><a href="../blc-body/index.php">
                                                                <p class="mt-icon-list-text"
                                                                    style="font-size: 12px; color: #232331">BLC body
                                                                </p>
                                                            </a></div>
                                                        <div class="mt-icon-list-item"><a href="../wlc-body/index.php">
                                                                <p class="mt-icon-list-text"
                                                ...
                                                <div class="vc_column-inner">
                                                    <div class="wpb_wrapper">
                                                        <div class="vc_empty_space" style="height: 20px"><span
                                                                class="vc_empty_space_inner"></span></div>
                                                        <div class="mt-icon-list-item"><a
                                                                href="../youth-wing/index.php">
                                                                <p class="mt-icon-list-text"
                                                                    style="font-size: 12px; color: #232331">Youth Wing
                                                                </p>
                                                            </a></div>
                                                        <div class="mt-icon-list-item"><a
                                                                href="../nari-wing/index.php">
                                                                <p class="mt-icon-list-text"
                                                ...
                                                <div class="vc_column-inner">
                                                    <div class="wpb_wrapper">
                                                        <div class="vc_empty_space" style="height: 20px"><span
                                                                class="vc_empty_space_inner"></span></div>
                                                        <div class="mt-icon-list-item"><a
                                                                href="../event-form/index.php">
                                                                <p class="mt-icon-list-text"
                                                                    style="font-size: 12px; color: #232331">Add News
                                                                </p>
                                                            </a></div>
                                                        <div class="mt-icon-list-item"><a
                                                                href="../voter-registeration/index.php">
                                                                <p class="mt-icon-list-text"
                                                                    style="font-size: 12px; color: #232331">Add Voter
                                                                </p>
                                                            </a></div>
                                                        <div class="vc_empty_space" style="height: 20px"><span
                                                                class="vc_empty_space_inner"></span></div>
                                        ...
                                        <div class="vc_column-inner">
                                            <div class="wpb_wrapper">
                                                <div class="title-subtile-holder">
                                                    <h1 class="section-title dark_title">CLC Body
                                                    </h1>
                                                    </br>
                                                </div>
                                            </div>
