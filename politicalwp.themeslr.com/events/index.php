			...
			<div id="tribe-events" class="tribe-no-js" data-live_ajax="1" data-datepicker_format="1" data-category=""
				...
				<div id="tribe-events-content-wrapper" class="tribe-clearfix"><input type="hidden"
					...
					<div id="tribe-events-content" class="tribe-events-list">
						<h2 class="tribe-events-page-title">Events</h2>
						...
						<?php
							if($eventDetails != FALSE && $eventDetails->num_rows > 0) {
								...
								$remSpTitle = preg_replace("/\s+/", "", $events['title']);
						?>
				<div id="post-5716"
...
?>
									<div class="<?php echo 'some'.$events['id']; ?>">	<video class="img-sizees" width="100%" controls>
  <source src="data:video/mp4;charset=utf8;base64,<?php echo base64_encode($events['video']); ?>" type="video/mp4">
</video></div>
...
<div class="<?php echo 'some'.$events['id']; ?>">
  <img class="img-sizees" src="data:image/jpg;charset=utf8;base64,<?php echo base64_encode($events['image']); ?>" >  
</div>

<?php
}
  
if ($events['image2'] != null) {
?>

<div class=" <?php echo 'some'.$events['id']; ?>">
  <img class="img-sizees" src="data:image/jpg;charset=utf8;base64,<?php echo base64_encode($events['image2']); ?>"  >
  
</div>

<?php
}
if ($events['image3'] != null) {
?>

<div class="mySlides <?php echo 'some'.$events['id']; ?>">
  <img class="img-sizees" src="data:image/jpg;charset=utf8;base64,<?php echo base64_encode($events['image3']); ?>" >
...
function <?php echo $remSpTitle.'(n)';?> {
  let i;
  let slides = document.getElementsByClassName("<?php echo 'some'.$events['id'] ?>");
